...
def public_plans() -> dict:
    return {
        "titulo": "Monetizacao responsavel",
        "subtitulo": (
            "O Foundy continua gratuito para encontrar e devolver itens. "
            "Os planos pagos ajudam a manter seguranca, moderacao e infraestrutura."
        ),
        ...
        "plans": [
            {
                ...
                "description": "Selo de confianca, pagina publica, QR Code e mais visibilidade para catalogos institucionais.",
                "benefits": [
                    "Selo de Empresa Verificada",
                    "Pagina publica personalizada",
                    "QR Code para recepcao ou balcao",
                    "Catalogo com destaque na aba Empresas",
                    "Suporte prioritario por e-mail",
                ],
                "ethical_notice": "O selo indica analise cadastral, mas usuarios ainda devem seguir o Protocolo Foundy.",
            ...
            },
            {
                ...
                "description": "Locais parceiros onde devolucoes podem ser combinadas em ambiente publico e monitorado.",
                "benefits": [
                    "Selo Ponto Seguro Foundy",
                    "Aparece como ponto seguro no mapa",
                    "Pagina publica com horario de atendimento",
                    "QR Code para orientar usuarios",
                ],
                "ethical_notice": "Combine devolucoes em locais publicos e nunca compartilhe dados pessoais sensiveis.",
            ...
            },
            {
                ...
                "amount_cents": 0,
                "description": "Contribuicao voluntaria para manter servidores, seguranca e melhorias da comunidade.",
                "benefits": [
                    "Ajuda a manter a plataforma gratuita",
                    "Apoia moderacao e seguranca",
                    "Permite evoluir recursos comunitarios",
                ],
                "ethical_notice": "Apoiar e opcional e nao altera suas chances de recuperar ou devolver um item.",
                "cta": "Apoiar o Foundy",
            },
            {
                "id": "loss_alert_boost",
                ...
                "amount_cents": 490,
                "description": "Destaque leve e temporario para alertas de perda criados gratuitamente.",
                "benefits": [
                    "Maior visibilidade no feed de perdas",
                    "Badge de Alerta Ampliado",
                    "Duracao limitada e transparente",
                ],
                "ethical_notice": "Este recurso nao garante a recuperacao do item. Ele apenas aumenta a visibilidade por tempo limitado.",
...
def manual_payment_instructions(amount_cents: int, reference: str) -> dict:
    ...
    if settings.foundy_support_pix_key:
        ...
        instructions.append("Chave PIX ainda nao configurada. Entre em contato pelo e-mail oficial para concluir.")
    return {
        "manual_payment_reference": reference,
        "support_email": settings.support_email,
        "support_pix_key": settings.foundy_support_pix_key,
        "instructions": instructions,
        "message": "Solicitacao registrada. Aguarde confirmacao manual pelo Foundy.",
    }


def boost_price(boost_type: str) -> dict:
    if boost_type not in LOSS_ALERT_BOOSTS:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Plano de destaque invalido.")
